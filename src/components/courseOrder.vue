  ...
  <div class="courseOrder">
    ...
    <div class="tableData">
      <el-table ref="dragTable" style="width: 100%;" height="calc(100vh - 350px)" :data="newArr" row-key="id">
        ...
        <el-table-column label="提交/保存时间" prop="createTime" width="220px">
          <template slot-scope="scope">
