<template>
  <div class="myAttention">
    ...
    <div class="content">
      ...
      <AttentionCom :nowIndex='nowIndex' v-if="nowIndex.indexOf('关注的问题')==-1" :attentionData="attentionData" :noMore="noMore" :loading="loading" @getMore="getMore" :key="updateKey"></AttentionCom>
    </div>
  </div>
</template>
