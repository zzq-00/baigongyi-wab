    ...
    <div class="box">
      <div class="left">
        <el-menu :default-active="$route.path" mode="horizontal" @select="handleSelect">
          ...
          <el-menu-item index="/myHome/myYiVideo">驿视频 {{userInfoData.yiVideoCount}}</el-menu-item>
          <el-submenu index="6">
...
export default {
  ...
  data() {
    return {
      ...
      rightList: [
        ...
        { imgs: require('@/assets/images/yivideo.png'), name: '收藏的驿视频', number: '0' },
  ...
  methods: {
    ...
    async getUserCollectCount() {
      ...
      this.rightList[3].number = numbers.yivideoCount
      this.rightList[4].number = numbers.articleCount
      this.rightList[5].number = numbers.answerCount
      this.rightList[6].number = numbers.concernQuestionCount
    }
  }
}
</script>
