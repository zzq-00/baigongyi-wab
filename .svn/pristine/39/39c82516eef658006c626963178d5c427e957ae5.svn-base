    ...
    <div class='hot-news fl'>
      ...
      <div class="news-list">
            ...
            <li class="clearfix" v-for="(item,index) in headLinesList[newActiveIndex]" :key="index">
              ...
              <div class="news-introduce">
                ...
                <p class="news-components">
                  ...
                  <span>{{item.publishTime | formatDate('noTime')}}</span>
                </p>
              </div>
            </li>
          </ul>
        ...
        <div class="news-picture">
          <img src="@/assets/images/picture1.png" alt="" @click="gototab('column')">
          <img src="@/assets/images/picture2.png" alt="" @click="gototab('course')">
        </div>
      </div>
    </div>
    <div class="curriculum fr">
      ...
      <div class="curriculum-hot">
        ...
        <p class="curriculum-teacher clearfix">
          ...
          <span class="fr" v-if="newGoodLessonsFrist.price">{{newGoodLessonsFrist.price=='0.00'?'免费':'&yen;'+newGoodLessonsFrist.price}}</span>
        </p>
      </div>
        ...
        <ul>
          <li v-for="(item,index) in newGoodLessons" :key="index" v-if="index==0||index==1">
            ...
            <p class="curriculum-teacher clearfix">
              ...
              <span class="fr">{{item.price=='0.00'?'免费':'&yen;'+item.price}}</span>
            </p>
          </li>
        </ul>
      </div>
...
export default {
  ...
  data() {
    return {
      hotnewsTitleList: ['环球资讯', '行业热点', '建筑前沿', '资质热点', '职场资讯'],
      newActiveIndex: 0,
      newGoodLessonsFrist: {
        image: '',
        name: '',
  ...
  methods: {
    ...
    gototab(val) {
      let routeUrl = this.$router.resolve(`lectureRoom?activeTab=${val}`)
      window.open(routeUrl.href, '_blank')
    }
  },
  mounted() {}
